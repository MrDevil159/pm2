...
var options = {
  ...
  spa_base_href: process.env.PM2_SERVE_SPA_BASEHREF || null,
...
function serveFile(uri, request, response) {
  ...
  if(options.spa_base_href && file.startsWith(options.spa_base_href)) {
    file = file.slice(options.spa_base_href.length - 1);
  }
  if (file === '/' || file === '') {
